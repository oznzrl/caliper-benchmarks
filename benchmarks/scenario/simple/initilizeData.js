 ...
 */
class initilizeData extends OperationBase {
    ...
    async submitTransaction() {
        ...
        await this.sutAdapter.sendRequests(this.createConnectorRequest('initilizeData', createArgs));
    }
}
