 ...
 */
class updateDataById extends OperationBase {
    ...
    async submitTransaction() {
        const queryArgs = this.simpleState.getUpdateArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('updateDataById', queryArgs));
    }
}
